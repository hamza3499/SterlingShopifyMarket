...
import { User, Lock, Eye, EyeOff, ArrowRight, ShoppingBag, Sparkles, MessageSquare, Send, X, ShieldCheck } from "lucide-react";
...
export default function Login() {
  ...
  // PUBLIC UNAUTHENTICATED SUPPORT MODAL STATE
  ...
  return (
    <div 
      className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center font-sans px-4 sm:px-6 py-10"
      style={{
    ...
    >
      ...
      <div className="absolute -bottom-40 -left-32 w-[450px] h-[450px] bg-cyan-500/20 rounded-full blur-[100px] pointer-events-none" style={{ animationDelay: "3s" }} />
      <div className="absolute top-1/3 right-1/4 w-[350px] h-[350px] bg-indigo-600/20 rounded-full blur-[90px] pointer-events-none" style={{ animationDelay: "6s" }} />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl font-black tracking-tight text-white leading-tight mb-1.5"
          >
            Welcome <span className="bg-gradient-to-r from-cyan-300 via-blue-400 to-amber-300 bg-clip-text text-transparent">Back</span>
          </motion.h1>
          ...
          <motion.div
            ...
            className="w-32 h-0.5 bg-gradient-to-r from-transparent via-cyan-400 to-transparent mx-auto my-3"
          />
          ...
          <motion.p
            ...
            className="text-[10.5px] font-black uppercase tracking-[0.3em] text-cyan-300/90 flex items-center justify-center gap-1.5"
          >
            <Sparkles size={12} className="text-amber-400 animate-spin" />
            <span>STERLING SHOPIFY MARKET</span>
          </motion.p>
        </div>
        ...
        <motion.div
          ...
          className="rounded-[36px] p-7 sm:p-8 relative bg-gradient-to-b from-[#0F1E4A]/95 via-[#0A1435]/95 to-[#060D26]/95 border-2 border-blue-400/35 shadow-[0_20px_60px_rgba(4,9,26,0.8)] backdrop-blur-2xl overflow-hidden"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 rounded-2xl font-black uppercase text-xs tracking-[0.18em] text-white shadow-[0_10px_30px_rgba(37,99,235,0.45)] mt-2 transition-all duration-200 disabled:opacity-70 cursor-pointer flex items-center justify-center gap-2 border border-blue-300/40"
              style={{
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-4 mt-6 text-[10px] font-black uppercase tracking-widest text-blue-300/70"
        >
      ...
      <AnimatePresence>
        {showSupportModal && (
          ...
          >
            ...
            >
              {/* Top Glow Orb */}
              <div className="absolute -top-20 -right-20 w-48 h-48 bg-cyan-400/15 rounded-full blur-3xl pointer-events-none" />
